...
**Python 3.13+** · **current pre-alpha: 0.25.0a1**
...
13. later: native x86-64/AArch64 or LLVM backend consuming the same typed/value/CALL IR and deoptimization contract
